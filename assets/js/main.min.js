...
document.addEventListener('DOMContentLoaded', function() {
  ...
  galleryGroupCards.forEach(card => {
    card.addEventListener('click', function() {
      ...
      } else if (groupId === 'tozan-2026-q1') {
        // Navigate to the 2026 Q1 gallery page
        window.location.href = 'gallery-2026-q1.html';
      } else if (groupId === 'tozan-aug-2023') {
        // Navigate to the 2023 gallery page
        window.location.href = 'gallery-2023.html';
      } else if (groupId === 'tozan-2006-2009') {
        // Navigate to the 2006 & 2009 gallery page
        window.location.href = 'gallery-2006-2009.html';
      } else if (groupId === 'tozan-2002') {
        // Navigate to the 2002 gallery page
        window.location.href = 'gallery-2002.html';
      }
    });
